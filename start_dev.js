...
let backendDir = path.join(__dirname, 'paimana-ai-llm-assistant', 'paimana-ai', 'backend');
let frontendDir = path.join(__dirname, 'paimana-ai-llm-assistant', 'paimana-ai', 'frontend');
